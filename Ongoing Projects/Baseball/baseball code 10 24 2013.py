...
data_norm = slimdata.drop(['teamID','group_A','group_B','group_C','group_D','group_E'],axis=1)
...
plt.scatter(hitters.AB_per_G, hitters.salary, cmap=plt.cm.jet, c='red')
plt.show()
...
pitchers['predicted'] = ols_results1.predict(X)



#Regression for Hitters
X = hitters12[['height','weight','Tot_Base','Age','group_A','group_B','group_C','group_D']]
hitters['predicted'] = ols_results2.predict(X)
